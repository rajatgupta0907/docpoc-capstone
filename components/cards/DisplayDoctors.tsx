...
interface Params {
  ...
  export default function DisplayDoctors({ id, bio, image, name, speciality }: Params) {
    let a=5;
    return(
                       

        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-[25px] p-[25px]"> {/* Added margin */}
        <Link href="#">

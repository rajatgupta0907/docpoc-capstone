...
const DisplayDetailedPrescriptions = ({ patientname, doctorname, uniqueappointmentid, description,typeofdisease, medicines }: Props) => {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="bg-blue-500 p-6 rounded-lg shadow-md">
        ...
        <p><span className="font-semibold">Doctor Name:</span> {doctorname}</p>
        <p><span className="font-semibold">Appointment Unique ID:</span> {uniqueappointmentid}</p>
        <p><span className="font-semibold">Type of Disease:</span> {typeofdisease}</p>

        <p><span className="font-semibold">Description Disease:</span> {description}</p>
      </div>
      ...
      <button onClick={handleDownloadInvoice} className='text-black py-2 px-4 md:py-3 md:px-6 bg-gray-200 hover:bg-gray-300 rounded-lg shadow-md'>
      Download Invoice
    </button>

...
const handleDeleteAppointment = async () => {
  ...
  return (
    ...
    <div className="md:flex">
        ...
        <Link  href='/my-appointment' className="mt-5 ml-3 px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
          No
        </Link>
